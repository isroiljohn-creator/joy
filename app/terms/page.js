...
const sections = [
  ...
  },
  {
    ...
    content: `maskon platformasi e'lonlar tarkibidagi ma'lumotlarning to'g'riligiga kafolat bermaydi. Biz foydalanuvchilar o'rtasidagi bitimlar uchun javobgar emasmiz. Platforma vositachilik xizmatini ko'rsatmaydi — faqat e'lon beruvchi va qidiruvchini bog'laydi. Texnik nosozliklar yoki ta'mirlash ishlari sababli xizmatning vaqtincha to'xtatilishi mumkin. Platforma foydalanuvchilar tomonidan yetkazilgan zarar uchun javobgarlik olmaydi.`,
  },
  {
    title: "7. Intellektual mulk",
    content: `Platformadagi barcha dizayn, kod, grafika va kontent maskon platformasining intellektual mulki hisoblanadi. Ruxsatsiz nusxa ko'chirish, tarqatish yoki o'zgartirish taqiqlanadi. Foydalanuvchilar joylashtirgan kontent (rasmlar, tavsiflar) foydalanuvchining o'ziga tegishli bo'lib qoladi, ammo platformada ko'rsatish huquqi maskonga beriladi.`,
  },
  {
    title: "8. Nizolarni hal qilish",
    content: `Platforma bilan bog'liq nizolar birinchi navbatda muzokaralar yo'li bilan hal qilinadi. Kelishuv erishilmagan taqdirda, nizo O'zbekiston Respublikasi qonunchiligiga muvofiq sudga murojaat qilish orqali hal etiladi. Barcha savol va shikoyatlar uchun info@maskon.uz manziliga murojaat qilishingiz mumkin.`,
  },
];
